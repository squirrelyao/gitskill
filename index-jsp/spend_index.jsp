...
<table id="spend"  style="width:80%;height:60%">
    <thead>
        <tr>
            ...
            <th data-options="field:'spend_date',width:80,formatter:dateFormate">spend_date</th>
    ...
    <div id="spend_btn" style="padding:5px;height:auto">
        ...
        <div>
            ...
            <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="spend_query()">查询</a>
        </div>
        </div>
</table>
      
<div id="spend_del_confirm" class="easyui-window" title="确认删除" style="width:400px;height:200px"   
    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="#" onclick="spend_del_confirm();" style="width:80px">确认删除</a>
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="#" onclick="spend_del_cancel();" style="width:80px">放弃退出</a>
        </div>
    </div>                
</div> 
